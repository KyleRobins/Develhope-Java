...
public class StringTest {
    ...
    private static void exercise2() {
        ...
        String middleName = "Robins";
        String lastName = "Mutuma";
    ...
    private static void exercise3() {
        ...
        String textFrom2Primitives = 1.5 + "" + 65 ;
        boolean b = true;
        int i = 10;
        // <--- Edit this line
        textFrom2Primitives = b + " " + i;
    ...
    private static void exercise4() {
        ...
        String numbers = (earlyNumbers +  " " + middleNumbers.trim() +  " " + endNumbers );
